...
const isInteger = (any) => isNumber(any) && Number.isInteger(any);
const isFinite = (any) => isNumber(any) && Number.isFinite(any);
...
const minInteger = fn(Math.min, isInteger)
const minFinite = fn(Math.min, isFinite)
const isNegative = (any) => isNumber(any) && any < 0;
const isNegativeInteger = (any) => isInteger(any) && isNegative(any)
const maxNegativeInteger = fn(Math.max, and(isInteger, isNegative))
...
const concat = (...args) =>  args.reduce((acc, curr) => acc + curr  ,'')
//   
